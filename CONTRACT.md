...
```
src/dhcp_toolkit/__init__.py            (version "2.1.0", short docstring; NO eager submodule imports)
...
name `dhcp-oru-toolkit`, version `2.1.0`, src layout, `requires-python>=3.8`,
