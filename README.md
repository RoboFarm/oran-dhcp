...
```sh
bash packaging/debian/build-deb.sh          # -> dist/dhcp-oru-toolkit_2.1.0_all.deb
sudo apt install ./dist/dhcp-oru-toolkit_2.1.0_all.deb
```
...
- [`docs/USER_MANUAL.md`](docs/USER_MANUAL.md) — the full operator user manual
  ...
  `docs/DHCP_Toolkit_v2.1.0_User_Manual.docx`.
...
```sh
make manual         # renders docs/DHCP_Toolkit_v2.1.0_User_Manual.docx
```
